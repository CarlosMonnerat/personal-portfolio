...
export default function About() {
   return (
      <section className="flex flex-row justify-evenly items-start gap-10 p-4 w-full max-w-7xl mx-auto rounded-xl border-1 border-purple-600 shadow-[0_0_30px_8px_rgba(192,132,252,0.5)]">
         <div className="flex flex-col justify-evenly items-center gap-10">
            ...
            <video
               className="max-w-sm h-full opacity-20 object-cover mix-blend-soft-light"
               autoPlay
               loop
               muted
               playsInline
